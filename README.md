...
| MakerBNB                     | Building a short-term rental website for travellers going away. User authentication. List properties with available dates. Rent properties with booking requests. Manage your property portfolio by confirming or denying booking requests    | Ruby on Rails, JavaScript, jQuery, CSS, HTML, RSpec, Travis CI, Heroku   |
